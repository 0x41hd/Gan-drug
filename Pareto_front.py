...
def main():
    ...
    df_original = pd.read_csv(
        folder_path+"full_data_inverted_SAS.csv", index_col=None)
    ...
    sns.scatterplot(data=data_p2, x=x_label, y=y_label,
                    hue="Rank", palette="dark:salmon_r")
    sns.lineplot(data=data_p2, x=x_label, y=y_label, hue="Rank",
